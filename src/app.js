            ...
            <div className="row align-items-center w-100">
                <div className="col-md-6 col-12 image-container">
                    <div className="image-wrapper" ref={imgWrapper}>
                        ...
                        <img className={`${isLoading ? 'not-visible' : 'visible'}`} ref={umbrellaImg} src={`src/assets/${activeColor}-umbrella.png`} alt="umbrella color image"></img>
                        <LoaderIcon class={`${activeColor}-color loader-big ${!isLoading ? 'not-visible' : 'visible'}`} />
                        <img className={`logo ${isLoading ? 'not-visible' : 'visible'}`} src={logo} />
